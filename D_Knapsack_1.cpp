...
// Memory Limit: 1024 MB (Mega Bytes)
// Time Limit: 2000 ms (milliseconds)
//
// Author: spexcher
// Name: Gourab Modak
// email: spexcher@gmail.com
// Institution: Indian Institute of Technology Madras(BS UG Data Science 4 year) + Jalpaiguri Government Engineering
// College (B. Tech UG CSE 4 year)....
//
...
void solve()
{
    ...
    Fo(i, 1, n + 1)
    {
        Fo(wt, 1, k + 1)
        {
            ...
            {
                int take = (wt >= v[i].ff) ? v[i].ss + dp[i - 1][wt - v[i].ff] : 0;
